...
class ConfigureTests(unittest.TestCase):
    def setUp(self):
        ...
        self.env = {
            ...
            'TLS_SECRET_NAME': 'backstage-tls', 'CLOUDFLARE_PROXIED': 'false',
        }
    ...
    def test_consistent_hostname_and_image(self):
        ...
        self.assertEqual(ingress['spec']['tls'], [{'hosts': [hostname], 'secretName': 'backstage-tls'}])
        ...
        self.assertIn({'name': 'BACKSTAGE_BASE_URL', 'value': 'https://' + hostname}, container['env'])
